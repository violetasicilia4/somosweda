        ...
        <div className="relative z-10 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-1">
            ...
            <button
              ...
              className="uppercase px-4 py-3 bg-white/10 hover:bg-white/20 border border-white/25 text-white rounded-xl text-xs font-normal inline-flex items-center justify-center gap-2 transition-colors cursor-pointer backdrop-blur-xs"
            >
              {copiedShare ? (
                <>
                ...
                <div className="flex items-center gap-2">
                  {allAdded ? (
                    <button
                      ...
                      className="uppercase text-xs font-normal text-emerald-700 hover:text-rose-600 border border-emerald-200 hover:border-rose-200 hover:bg-rose-50 rounded-lg px-3 py-1.5 inline-flex items-center gap-1.5 cursor-pointer transition-colors shrink-0"
                    >
                    ...
                    <button
                      ...
                      className="uppercase text-xs font-normal text-gray-700 hover:text-gray-900 border border-gray-200 hover:border-gray-300 hover:bg-gray-50 rounded-lg px-3 py-1.5 inline-flex items-center gap-1.5 cursor-pointer transition-colors shrink-0"
                    >
                  ...
                  <button
                    ...
                    className="uppercase text-xs font-normal text-gray-700 hover:text-gray-900 border border-dashed border-gray-300 hover:border-gray-400 hover:bg-gray-50 rounded-lg px-3 py-1.5 inline-flex items-center gap-1.5 cursor-pointer transition-colors shrink-0"
                  >
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-gray-100 space-y-6 animate-fade-in max-h-[92vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateCustomGift} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  className="uppercase px-5 py-2.5 bg-gray-900 hover:bg-black text-white rounded-xl text-xs font-normal transition-all shadow-xs cursor-pointer"
                >
                  Agregar a mi lista
                </button>
              </div>
