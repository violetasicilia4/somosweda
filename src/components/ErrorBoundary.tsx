      ...
      return (
        <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-6 text-neutral-800">
          <div className="max-w-md w-full bg-white rounded-2xl p-8 border border-neutral-200 shadow-sm text-center">
            ...
            <h2 className="text-xl font-normal mb-2 font-display text-neutral-900">
            ...
            <button
              ...
              className="uppercase inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-neutral-900 text-white text-xs font-normal rounded-xl hover:bg-neutral-800 transition-colors shadow-sm"
            >
